    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="content" class="col-sm-9">
          ...
          <div class="row">
            <div class="col-sm-3"><img src="{{URL::asset('front/image/product/store_location-275x180.jpg')}}" alt="MarketShop Template" title="MarketShop Template" class="img-thumbnail" /></div>
