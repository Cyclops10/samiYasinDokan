...
@section('product_page_js1')
<script type="text/javascript" src="{{URL::asset('front/js/jquery.elevateZoom-3.0.8.min.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('front/js/swipebox/lib/ios-orientationchange-fix.js')}}"></script>
<script type="text/javascript" src="{{URL::asset('front/js/swipebox/src/js/jquery.swipebox.min.js')}}"></script>
@endsection

@section('product_page_js2')
