          ...
          {{ csrf_field() }}
            <fieldset id="account">
              ...
              <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }} required">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="name" placeholder="Name" value="{{ old('name') }}" name="name" required autofocus>
                  @if ($errors->has('name'))
            ...
            <fieldset>
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="password" class="form-control" id="password-confirm" placeholder="Password Confirm" name="password_confirmation" required>
                </div>
              </div>
            </fieldset>
            {{--<fieldset>--}}
