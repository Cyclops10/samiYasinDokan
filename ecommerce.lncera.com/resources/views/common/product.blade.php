...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            <form id="summary-form" method="POST" action="{{ route('admin_product_post') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <section class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control" title="Please enter a name." placeholder="Ex.: White Samsung Mobile A9" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea class="form-control" rows="3" id="textareaAutosize" name="desc" data-plugin-textarea-autosize></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="available" class="form-control" title="Please enter a quantity." placeholder="Ex.: 500" required="">
                            </div>
                        </div>
                    </div>
                    <header class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="price" class="form-control" title="Please enter a price." placeholder="Ex.: 500" required="">
                            </div>
                        </div>
                    </div>
                    <header class="card-header">
                            ...
                            <div class="row col-md-12 spec_element" data-book-index="0">
                                <div class="col-md-11">
                                    <section class="card card-featured single_element mb-12">
                                        <header class="card-header">
                                            <input type="text" name="element[0][name]" class="form-control element_name" title="Please enter a Field Name." placeholder="Ex.: Color" required="">
                                        </header>
                                        <div class="card-body row">
                                            <div class="col-sm-4">
                                                <input type="text" name="element[0][value][]" class="form-control element_value" title="Please enter a Field Value." placeholder="Ex.: Red" required="">
                                            </div>
                                            <div class="col-sm-2">
                                                <input type="text" name="element[0][quan][]" class="form-control element_quan" title="Please enter a Field Quantity." placeholder="Ex.: 10" required="">
                                            </div>
                                            <div class="col-sm-1">
